...
import {MyFilterPipe} from './filter-pipe.component'
...
@Component({
    ...
    pipes: [ TodosSortPipe , MyFilterPipe]
...
export class todoAppComponent implements OnInit{
    ...
    constructor(private _todoService: TodoService,private _service:AuthenticationService) { };
